...
<div class="green-box" id="box1">
Wrapping it up!
</div>

```{block2, caution-text, type='caution'}
...
```{block2, warning-text, type='warning'}
Be careful, be gentle, be brave! 
And remember the above [box!](#box1)
```

```{block2, tip-text, type='tip'}
A tip!
```

```{block2, note-text, type='note'}
A note!
```

```{block2, important-text, type='important'}
